...
var _ = Gettext.domain("dash-from-panel").gettext
//Gettext.bindtextdomain("dash-from-panel", ExtensionUtils.getCurrentExtension().path + "/locale");
...
function buildPrefsWidget() {
    ...
    let maxHeightRatio = buildSpinButton('max-height-ratio',_("Dock height (%)"), 5, 15, 1);
    frame.append(maxHeightRatio);
